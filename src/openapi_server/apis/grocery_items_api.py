...
async def add_item(
    grocery_item_create: GroceryItemCreate = Body(None, description=""),
) -> GroceryItem:
...
async def delete_item(
    itemId: Annotated[StrictInt, Field(description="ID of the grocery item to delete")] = Path(..., description="ID of the grocery item to delete"),
) -> None:
...
async def get_item_by_id(
    itemId: Annotated[StrictInt, Field(description="ID of the grocery item to retrieve")] = Path(..., description="ID of the grocery item to retrieve"),
) -> GroceryItem:
...
async def update_item(
    itemId: Annotated[StrictInt, Field(description="ID of the grocery item to update")] = Path(..., description="ID of the grocery item to update"),
    grocery_item_create: GroceryItemCreate = Body(None, description=""),
) -> GroceryItem:
